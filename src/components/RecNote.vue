<template>
  <div>
    ...
    <el-breadcrumb style="padding-bottom:15px " separator="/">
      ...
      <el-breadcrumb-item>推荐笔记列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!--    页面内容-->
    <el-card>
      <!--    搜索头部-->
      ...
      <el-table
        ...
        <el-table-column
          ...
          <div slot-scope="scope">
            ...
            <el-button type="info" size="mini" @click="TuiJNote(scope.row)">取消推荐</el-button>
      ...
      <el-dialog
        ...
        <el-row :gutter="50" style="padding: 0 0 20px 100px;">
          <el-col :span="8">
            <div>笔记评论数:{{ UpdateNoteList.collecnum }}</div>
          </el-col>
          <el-col :span="8">
        ...
        <el-form :model="UpdateNoteList" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="专业">
            <el-select v-model="UpdateNoteList.majorid" placeholder="请选择">
              <el-option
...
export default {
  ...
  methods: {
    ...
    getNoteList(e) {
      ...
      this.$http.get("/NoteController/selectNoteTuiJ01", {
        params: {
          page: this.page,
          limit: this.limit,
